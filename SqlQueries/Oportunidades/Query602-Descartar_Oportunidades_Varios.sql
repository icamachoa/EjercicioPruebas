//[session.idempresa|Untyped,session.idusuario|Untyped,session.convertcode|Untyped,razones|Integer,comentario|Text,listao|Text,session.db|Untyped,tkrazon|Text,Tko|Text]
--INSERT
/*PROTEGIDO*/
...
IF @TKO != '' BEGIN SET @LISTA = <#SESSION.DB/>.dbo.obtieneListaIdOportunidades(@TKO) END
