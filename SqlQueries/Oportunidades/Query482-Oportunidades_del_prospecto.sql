//[session.idempresa|Untyped,tkp|Text,session.db|Untyped,listap|Text,idprospecto|Integer, ltkp|Integer]
--SELECT 
...
SET @LTKP = ISNULL(:ltkp, 0)
IF (@LTKP != 0) BEGIN SET @LISTAP = <#SESSION.DB/>.dbo.obtieneListaIdProspecto(@LISTAP, @IDEMPRESA)END
