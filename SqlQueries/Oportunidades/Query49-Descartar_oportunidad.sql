//[idprospecto|Text,idoportunidad|Text,session.idempresa|Untyped,session.idusuario|Untyped,razones|Text,comentario|Text,enviaactivado|Text,session.convertcode|Untyped,session.db|Untyped,tkp|Text,tko|Text,tkrazon|Text]
--INSERT
