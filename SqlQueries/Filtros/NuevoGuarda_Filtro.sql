...
EXEC  <#SESSION.DB/>.DBO.SP_NUEVO_GUARDA_FILTRO @IDEMPRESA, @IDUSUARIO, @IDGRUPO , @NIVEL , @CONVERTCODE , @IDPANTALLA , @FILTROTIPO , @FILTRODETALLE , @FILTRODETALLE2 , @FILTROTXT , @FECHA_INICIO , @FECHA_FIN, '<#SESSION.DB/>' , @NEGATIVO