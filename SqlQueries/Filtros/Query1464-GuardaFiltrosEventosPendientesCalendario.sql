...
BEGIN
 	...
 	IF @VALOR = '3'
 	BEGIN
 		SET @TEXTO = 'Completados'
		SET @SQLRECORDATORIOS = ' 1=1 '
		SET @SQLTAREAS = ' T.IDESTADO = 2 ' 
		SET @SQLCITAS = ' 1=1 '
		SET @SQLCOBROSPENDIENTES = ' 1=1 '
		SET @SQLCOBROSAUDITAR = ' 1=1 '
 	END
 	IF @VALOR = '4'
 	BEGIN
 		SET @TEXTO = 'En proceso'
		SET @SQLRECORDATORIOS = ' 1=1'
		SET @SQLTAREAS = ' T.IDESTADO = 1 ' 
		SET @SQLCITAS = ' 1=1 '
		SET @SQLCOBROSPENDIENTES = ' 1=1 '
		SET @SQLCOBROSAUDITAR = ' 1=1 '
 	END
