...
DECLARE @MANTENIMIENTODB INT
DECLARE @CAMBIARPRECIOS INT

DECLARE @ETIQUETAR INT
DECLARE @PUEDECOMPARTIR INT
...
SET @MANTENIMIENTODB = ISNULL(:MANTENIMIENTODB,0)
SET @CAMBIARPRECIOS      = ISNULL(:CAMBIARPRECIOS,0)
SET @ETIQUETAR           = ISNULL(:ETIQUETAR,'')
SET @PUEDECOMPARTIR      = ISNULL(:PUEDECOMPARTIR,'')
/*VARIABLES SET*/
...
BEGIN
 ...
 INSERT INTO <#SESSION.DB/>.DBO.USUARIOS(IDUSUARIO,IDEMPRESA,NOMBRE,APELLIDOS,CONTRASENA, INICIALES,
                                        EMAIL,NIVEL,IDGRUPO, DEFAULT_PAIS, DEFAULT_ESTADO, GMT,AVATAR, PUEDEEXPORTAR, VERSISTEMA, USUARIOTELEFONO, USUARIOMOVIL , USUARIOPUESTO, CREARETIQUETAS, TKU, IDCSS,FUERZA_CONTRASENA, COMISION, CREAREMPRESAS,CREARPLANTILLAS,CREARCOMUNICACIONES,CREARDOCUMENTOS,HACERDESCUENTOS,CAMBIARPRECIOS,ETIQUETAR,PUEDECOMPARTIR,MANTENIMIENTODB) 
VALUES 
