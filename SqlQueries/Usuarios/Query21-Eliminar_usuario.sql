...
-- Prospectos
SELECT @CONTADOR = COUNT(1) FROM <#SESSION.DB/>.DBO.PROSPECTOS WHERE IDUSUARIO = @IDELIMINAR
...
SELECT @CONTADOR = COUNT(1) FROM <#SESSION.DB/>.DBO.USUARIOS_SUCESOS WHERE IDUSUARIO = @IDELIMINAR
...
SELECT @CONTADOR = COUNT(1) FROM <#SESSION.DB/>.DBO.PROSPECTOS_SEGUIMIENTO WHERE IDUSUARIO = @IDELIMINAR
...
-- Usuarios Cronologia
DELETE FROM <#SESSION.DB/>.DBO.USUARIOS_CRONOLOGIA WHERE IDUSUARIO=@IDELIMINAR
-- Usuarios
