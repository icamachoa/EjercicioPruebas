...
function MisMetas() {
  ...
  $('.BodyModal #Tabs').tabs();
    ...
    if(ganadas) {
        $('#divTab-ganadas').html('<div id="loadingsalesup"><img src="../estilos/login/salesup.png" /></div>');
        ...
        $('#divTab-Noganadas').html('<div id="loadingsalesup"><img src="../estilos/login/salesup.png" /></div>');
        setTimeout(function() {
          SalesUp.Sistema.OcultaEspera();
          RecargaDatosTab(0, 3);
          Animacion2();
          ...
          CambiaTamanio('ganadas');
            ...
            $('#divTab-0').html('<div id="loadingsalesup"><img src="../estilos/login/salesup.png" /></div>');
            setTimeout(function() {
              SalesUp.Sistema.OcultaEspera();
              $('#Tab-0 a').click();
              Animacion2();
...
function RecargaPeriodoPop(periodo, tamanio, tipo){
  ...
  if(tipo==1){
  tamPantalla=0;
    $('#divTab-'+periodo).html('<div id="loadingsalesup"><img src="../estilos/login/salesup.png" /></div>');
  setTimeout(function() {
    SalesUp.Sistema.OcultaEspera();
