...
var reporteActividades = function(){
	...
	this.reportePorPeriodo = function(obj){
		...
		var muestraReporteActividades = function(Op,err){
			...
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' Nuevos '+1+'}}"><b>{{hlpEsCero Nuevos}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' Asignados '+2+'}}"><b>{{hlpEsCero Asignados}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' Descartados '+3+'}}"><b>{{hlpEsCero Descartados}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' OpNuevas '+4+'}}"><b>{{hlpEsCero OpNuevas}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' OpDescartadas '+5+'}}"><b>{{hlpEsCero OpDescartadas}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' Ventas '+6+'}}"><b>{{hlpEsCero Ventas}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' Seguimiento '+7+'}}"><b>{{hlpEsCero Seguimiento}}</b></a></td>';
			tmpBody += '<td class="centrado"><a href="{{hlpLinkActividadesPeriodo '+data.filtros[0].fecha_desde+' '+data.filtros[0].fecha_hasta+' '+agrupar+' '+data.filtros[0].periodo+' SeguimientoPV '+8+'}}"><b>{{hlpEsCero SeguimientoPV}}</b></a></td>';
			tmpBody += '</tr>';
	...
	/*************************************** Reporte actividades succesos ***************************************************/
		...
		var vistaReporteSuceso = function(Op){
			...
			tBody                           += '<td>{{TEXTO}}</td>';
			tBody                           += '<td>{{hlpSucesosCuerpo}} {{NOMBRE}} {{APELLIDOS}} <br /> <span style="font-size:10px">{{CORREO}}</span><br>{{hlpSucesosEmpresa}}</td>';
