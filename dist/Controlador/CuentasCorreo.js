...
Handlebars.registerHelper('Config', function(idusuariocorreo,tipo,configuracion) {
    ...
    if(tipo == 1 || tipo == 3){
      resultado = '<span class="Pointer" onclick="SalesUp.Variables.ConfigurarCuenta({e:this});" data-idusuariocorreo="'+idusuariocorreo+'"><i class="fa fa-lg fa-cog Tip6" tip="Configuraciones extra" original-title=""></i></span>';
    }else{
      resultado = '';
    }
