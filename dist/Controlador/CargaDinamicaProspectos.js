...
function RecargaTablas() {console.log('entra');
...
SalesUp.Variables.ProspectoReactivaCorreos = function(Op){
  var url = SalesUp.Variables.reactivaCorreosProspecto+'&idprospecto='+SalesUp.Variables.idp+'&correo='+Op.correo+'&idusuario='+Op.usuario+'&agente='+escape(Op.ejecutivo)
  ...
  $.ajax({ async:false,cache:false,dataType:'html',
    url:url, success:function(data){ SalesUp.Variables.DatosProspecto();}
  });
}
